...
if __name__ == '__main__':
    ...
    parser.add_argument('--gamma', help='models the long term returns', default=0.999)
    parser.add_argument('--noise_var', help='Variance of the exploration noise', default=0.0925)
    parser.add_argument('--scaling', help='weather to scale the states before using for training', default=True)
    
    #model/env paramerters
    parser.add_argument('--state_dim', help='state dimension of environment', default=state_dim)
    parser.add_argument('--action_dim', help='action space dimension', default=action_dim)
    parser.add_argument('--action_bound', help='upper and lower bound of the actions', default=action_bound)
